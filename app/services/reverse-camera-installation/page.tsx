...
export const metadata = {
  title: "Reverse Camera Installation Sydney — UpFit",
  description:
    "Professional reverse camera installation across Sydney. Mobile service, wired to your existing or new display. From $220.",
};
    ...
    <main>
      ...
      <section className="px-10 py-20 border-b border-white/[0.08] max-w-3xl">
        ...
        <p className="text-upfit-muted text-lg font-light leading-relaxed mb-8 max-w-xl">
          Wired reverse camera integrated with your existing display or a new
          screen. Crystal clear image, professional install. From $220.
        </p>
